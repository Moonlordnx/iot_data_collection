...
1. Наведи курсор на папку проекта слева
2. Нажми на иконку 📁 **"New Folder"**
3. Введи новое имя папки → Enter
4. Повтори для всех папок

## 🔌 Часть 3: Прошивка микроконтроллера (эмуляция)

### 💻 Шаг 3.1: Создаём эмулятор микроконтроллера

**Создай файл `sensor_emulator.py` в папке `device_firmware/`:**
...
**Создай файл `data_receiver.py` в папке `data_server/`:**
...
**Создай файл `database_viewer.py` в папке `data_server/`:**
